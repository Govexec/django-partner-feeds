...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Partner', fields ['name']
        db.create_index('partner_feeds_partner', ['name'])


    def backwards(self, orm):
        
        # Removing index on 'Partner', fields ['name']
        db.delete_index('partner_feeds_partner', ['name'])
